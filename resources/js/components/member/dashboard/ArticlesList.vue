                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input  name="slug" type="text" v-model="fields.slug" class="form-control" :class="{'is-invalid': errors.slug }" id="slug"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="short_description" id="short_description" :class="{'is-invalid': errors.short_description }" v-model="fields.short_description"></textarea>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submitDeleteArticle() {
                axios.delete('/api/member/articles/' + this.fields.id + "?api_token=" + this.api_token, this.fields).then(response => {
            ...
            submit() {
                ...
                if (!this.editing) {
                    axios.post('/api/member/articles', fd).then(response => {
                        this.clearModalFields();
                        this.success = true;
                        this.errors = {};
                        this.getArticles();
                    ...
                    axios.post('/api/member/articles/post-update/' + this.fields.id, fd).then(response => {
                        this.clearModalFields();
                        this.success = true;
                        this.errors = {};
                        this.getArticles();
            ...
            getArticles() {
                let request_url = '/api/member/articles?api_token=' + this.api_token;

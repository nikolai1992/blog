...
<div class="wrapper" id="app">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="#" class="brand-link">
            ...
            <span class="brand-text font-weight-light">Blog Test Task</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('member.dashboard.blog') }}" class="nav-link active">
...
<script type="text/javascript" charset="utf8" src="{{ asset('/dist/js/jquery.dataTables.js') }}"></script>
</body>
</html>
